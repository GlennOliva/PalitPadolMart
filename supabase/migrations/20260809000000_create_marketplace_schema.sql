...
-- Marketplace schema: enums, helper functions, tables, RLS, triggers, indexes.
--
-- Conventions:
...
-- Public-facing subset of profiles (no role/status/contact). Definier view:
...
-- Column-level grants below restrict which columns UPDATE may touch.
